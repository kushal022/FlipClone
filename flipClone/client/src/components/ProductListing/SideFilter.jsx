    ...
    return (
        <div className="hidden sm:flex flex-col w-1/5 px-1">
            <div className="flex flex-col bg-white rounded-sm shadow">
                <section className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                ...
                <section className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                    {/* Price bar slider filter */}
